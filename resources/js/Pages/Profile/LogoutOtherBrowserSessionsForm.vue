<template>
    <jet-action-section>
        ...
        <template #description>
            Gerencie e saia das suas sessões ativas em outros navegadores e dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
              Se necessário, você pode fazer logout de todas as outras sessões do navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo; no entanto, esta lista pode não ser detalhada. Se você acha que sua conta foi comprometida, você também deve atualizar sua senha
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="confirmingLogout = false">
                ...
                <template #content>
                    Por favor, digite a sua senha para confirmar o logout nos outros navegadores e dispositivos.
